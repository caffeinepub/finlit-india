import { c as createContextScope, r as reactExports, u as useControllableState, j as jsxRuntimeExports, a as useId, P as Primitive, b as composeEventHandlers, d as Presence, e as useComposedRefs, f as useLayoutEffect2, R as React, g as createCollection, h as useDirection, i as cn, C as ChevronDown, k as clsx, B as BookOpen, L as Link, l as Button, T as TrendingUp, S as Shield, m as useLanguage } from "./index-C2gTZAc5.js";
import { W as Wallet } from "./wallet-Ct5zTqwG.js";
...
import { L as LineChart, a as Line } from "./LineChart-Cqbq7HU1.js";
...
import { P as PiggyBank } from "./piggy-bank-D8xOhFct.js";
import { T as TrendingDown } from "./trending-down-J77aU8L0.js";
import { U as Users } from "./users-Kk64P6L7.js";
...
const REAL_STORIES = [
  {
    ...
    story: "Meena had no income of her own. She enrolled in PMJDY, opened a zero-balance account, and linked it to PMJJBY for ₹436/year life insurance. When her husband passed away unexpectedly, she received ₹2 lakh within 30 days — enough to pay off the remaining home loan EMIs and keep her children in school.",
  ...
  },
  {
    ...
    story: "Arjun started a ₹3,000/month SIP in a Nifty 50 index fund at 23. By 27, he'd invested ₹1.44 lakh but his portfolio was worth ₹2.1 lakh. He now increases his SIP by 10% every year. His projected retirement corpus at 60: ₹4.2 crore — from a ₹3,000/month habit started at 23.",
    tag: "Investing",
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-semibold bg-primary/10 text-primary px-3 py-1 rounded-full mb-3", children: t.common.realLifeStory }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-3xl font-bold text-foreground mb-2", children: t.home.realStoryTitle })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: REAL_STORIES.map((story, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          className: "text-center mb-10",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-semibold bg-primary/10 text-primary px-3 py-1 rounded-full mb-3", children: t.common.govLinks }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-3xl font-bold text-foreground mb-2", children: t.home.govResourcesTitle }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: t.home.govResourcesSubtitle })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: GOV_RESOURCES.map((res, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.a,
        {
          href: res.url,
          target: "_blank",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground truncate", children: res.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3 text-muted-foreground shrink-0 group-hover:text-primary transition-colors" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 leading-snug", children: res.desc })
            ] })
          ]
        },
        res.short
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-muted/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          className: "text-center mb-10",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-3xl font-bold text-foreground mb-2", children: t.home.faqTitle }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: t.home.faqSubtitle })
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-navy-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-white mb-4", children: t.home.ctaTitle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 mb-8 max-w-lg mx-auto", children: t.home.ctaSubtitle }),
