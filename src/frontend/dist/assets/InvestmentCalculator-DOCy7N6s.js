import { r as reactExports, u as useControllableState, j as jsxRuntimeExports, c as createContextScope, g as createCollection, b as composeEventHandlers, P as Primitive, e as useComposedRefs, h as useDirection, s as useSize, i as cn, l as Button } from "./index-C2gTZAc5.js";
import { I as Input } from "./input-D-QuSoeY.js";
import { L as Label } from "./label-BZQkoq3e.js";
import { c as clamp, u as usePrevious } from "./index-VhMS8pNo.js";
import { P as PageHeader } from "./PageHeader-CAZihj1C.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, p as Legend } from "./generateCategoricalChart-D4zM1Nt9.js";
...
function InvestmentCalculator() {
  ...
  const calc = reactExports.useMemo(() => {
    if (mode === "sip") {
      const n = years * 12;
      const r = rate / 100 / 12;
      const fv2 = r === 0 ? amount * n : amount * (((1 + r) ** n - 1) / r) * (1 + r);
      const invested = amount * n;
      return {
        fv: Math.round(fv2),
        invested,
        returns: Math.round(fv2 - invested)
      };
    }
  ...
  const chartData = reactExports.useMemo(() => {
    return Array.from({ length: years + 1 }, (_, y) => {
      if (mode === "sip") {
        ...
        const r = rate / 100 / 12;
        const fv2 = r === 0 ? amount * n : amount * (((1 + r) ** n - 1) / r) * (1 + r);
        return { year: y, invested: amount * n, value: Math.round(fv2) };
      }
      const fv = amount * (1 + rate / 100) ** y;
      return { year: y, invested: amount, value: Math.round(fv) };
    });
  }, [mode, amount, rate, years]);
  const scenarioCalcs = reactExports.useMemo(() => {
    return SCENARIOS.map((s) => {
      if (mode === "sip") {
        const n = years * 12;
        const r = s.rate / 100 / 12;
        const fv2 = r === 0 ? amount * n : amount * (((1 + r) ** n - 1) / r) * (1 + r);
        return { ...s, fv: Math.round(fv2) };
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4", children: "Investment Type" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5 shadow-card space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-sm mb-2 block", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-sm mb-3 block", children: [
              "Annual Return Rate: ",
              rate,
              "%"
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "1 yr" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "40 yrs" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-foreground mb-3", children: "Return Scenarios" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: scenarioCalcs.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-semibold text-sm ${s.color}`, children: fmt(s.fv) })
              ]
            },
            s.label
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 text-center shadow-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg font-bold text-primary", children: fmt(calc.invested) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: "Total Invested" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 text-center shadow-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg font-bold text-green-600", children: fmt(calc.returns) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: "Total Returns" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 text-center shadow-card border-primary/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg font-bold text-foreground", children: fmt(calc.fv) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: "Future Value" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-4", children: "Wealth Growth Over Time" }),
            ...
            LineChart,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    tick: { fontSize: 10 },
                    tickFormatter: (v) => v >= 1e5 ? `${(v / 1e5).toFixed(1)}L` : v.toLocaleString("en-IN")
                  }
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 border border-primary/20 rounded-xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Summary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
            "By investing",
            " ",
            mode === "sip" ? `₹${amount.toLocaleString("en-IN")} monthly` : `₹${amount.toLocaleString("en-IN")} as lump sum`,
            " ",
            "at an annual return of ",
            rate,
            "% for ",
            years,
            " years, your investment of",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: fmt(calc.invested) }),
            " ",
            "will grow to",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-primary", children: fmt(calc.fv) }),
            ", generating returns of",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-green-600", children: fmt(calc.returns) }),
            "."
          ] })
        ] })
      ] })
