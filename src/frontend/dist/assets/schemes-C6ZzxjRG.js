import { m as createLucideIcon } from "./index-C9PNr72X.js";
/**
...
const GOVERNMENT_SCHEMES = [
  {
    ...
    shortName: "PMJDY",
    description: "A national mission for financial inclusion ensuring access to financial services like banking, savings accounts, remittance, credit, insurance and pension in an affordable manner.",
    benefits: [
  ...
  },
  {
    ...
    shortName: "PMJJBY",
    description: "A government-backed life insurance scheme offering affordable life cover at a nominal premium of ₹436 per annum. Provides financial security to families of the insured in case of death.",
    benefits: [
  ...
  },
  {
    ...
    shortName: "PMSBY",
    description: "An accidental insurance scheme providing coverage for accidental death and disability. Offers ₹2 lakh cover at just ₹20 per annum, making it highly accessible to low-income groups.",
    benefits: [
  ...
  },
  {
    ...
    shortName: "APY",
    description: "A government-backed pension scheme focused on workers in the unorganised sector. It guarantees a fixed monthly pension of ₹1,000–₹5,000 after the age of 60, based on contribution amount and age of entry.",
    benefits: [
  ...
  },
  {
    ...
    shortName: "PMMY",
    description: "A flagship scheme providing loans up to ₹10 lakh to small and micro enterprises. Supports entrepreneurs in setting up and expanding businesses without collateral through three loan categories: Shishu, Kishore, and Tarun.",
    benefits: [
  ...
  },
  {
    ...
    description: "A flagship programme to transform India into a digitally empowered society and knowledge economy. It encompasses digital infrastructure, digital literacy, and digital services delivery for all citizens.",
    benefits: [
