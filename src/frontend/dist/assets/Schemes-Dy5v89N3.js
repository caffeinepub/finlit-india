import { n as createLucideIcon, r as reactExports, j as jsxRuntimeExports, l as Button, C as ChevronDown, o as useLocalStorage, m as useLanguage } from "./index-C2gTZAc5.js";
...
import { B as BookmarkCheck, G as GOVERNMENT_SCHEMES } from "./schemes-DvKonRJg.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-100 dark:bg-amber-800/40 rounded-xl p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "h-5 w-5 text-amber-600" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-amber-900 dark:text-amber-200 text-sm mb-1", children: t.schemes.realTipTitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-800 dark:text-amber-300 text-sm leading-relaxed", children: t.schemes.realTipDesc })
            ] })
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap mb-8", children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `px-4 py-1.5 rounded-full text-sm font-medium transition-colors border min-h-[36px] ${activeCategory === cat ? "bg-primary text-primary-foreground border-primary" : "bg-card text-muted-foreground border-border hover:border-primary hover:text-primary"}`,
          children: cat
        },
        cat
      )) }),
